...
$("#navi").click(function(){
	...
	if($("#sidebar").width()===100){
		$("#sidebar").animate({width:'184px'},{duration:'slow',queue: false}).animate({height:'250px'},{duration:'slow',complete: function(){$("#sidebar").css("height","auto");totyu="0";}});
	}else{
		$(".secmenu:lt(9)").slideUp(420);
		$(".secmenu:gt(9)").slideUp(420);
...
$("#one").click(function(){
	...
	$(".secmenu:lt(9)").slideToggle(500,function() {
		totyu="0";
	  });
	return;
});
$("#two").click(function(){
	...
	$(".secmenu:gt(9)").slideToggle(500,function() {
		totyu="0";
	  });
	return;
});
